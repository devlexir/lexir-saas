...
const classes = {
  root: 'px-4 h-12 mb-6 flex items-center w-full rounded appearance-none transition duration-300 ease-in-out text-heading text-sm focus:outline-none placeholder:text-[#CCCCCC] placeholder:text-sm focus:ring-0',
  normal:
    ...
    return (
      <div className={className}>
        <div className="mb-3 flex items-center justify-between">
          <label
            htmlFor={name}
            className="mb-1 block text-lg font-semibold leading-none text-body-dark sm:text-xl"
          >
            {label}
          </label>
