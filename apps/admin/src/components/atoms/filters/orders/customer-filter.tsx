...
import { customerFilterOrderAtom } from "@contexts/filters";
...
export default function CustomerFilter({ className }: Props) {
  const [customerFilterOrder, setCustomerFilterOrder] = useAtom(
  ...
  const handleChange = (e: {
    ...
    setCustomerFilterOrder(e.target.value);
  };
