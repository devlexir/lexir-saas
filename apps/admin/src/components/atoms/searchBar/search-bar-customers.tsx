...
import CityFilter from '../filters/customers/city-filter';
import ContactFilter from '../filters/customers/contact-filter';
import Customers from '../filters/customers/customers-filter';
import LatestOrderFilter from '../filters/customers/latest-order-filter';
import CustomerTypeFilter from '../filters/orders/customer-type-filter';

const SearchBarCustomers = ({ handleSearch, visible }: any) => {
  return (
      ...
      >
        <div
          className='flex flex-wrap md:flex-row md:items-center mt-5 md:mt-8 
            border-t border-gray-200 pt-5 md:pt-8 px-4 w-full gap-y-8 gap-x-2 sm:justify-around'
        >
          <Customers />
          <CityFilter />
          <CustomerTypeFilter />
...
export default SearchBarCustomers;
