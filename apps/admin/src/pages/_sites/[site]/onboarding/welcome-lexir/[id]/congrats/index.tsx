    ...
    <>
      ...
      <div className='flex h-screen w-full flex-col'>
        <div className='flex h-fit w-full'>
          <div className='z-30 hidden w-full justify-center px-10 py-12 md:flex'>
          ...
          <div className='relative hidden h-screen w-full md:flex '>
            <LoginSuccessSvg className='absolute inset-x-0 top-[25%] z-40 w-full' />
