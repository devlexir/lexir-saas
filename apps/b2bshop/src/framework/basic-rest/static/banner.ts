...
export const HeroBannerCurated = {
  id: 1,
  title: "A Curated Collection of ",
  green_title: "Craft Spirits",
  button_text: "Discover Spirits",
  slug: '/search',
  description: "Discover our collection of premium craft spirits - made by independent producers from around the world.",
  image: {
    // mobile: {
    //   url: '/assets/images/banner/banner-12.jpg',
    //   width: 450,
    ...
    // },
    desktop: {
      url: '/assets/images/hero/hero-curated.png',
      width: 594,
      height: 415
    },
  },
