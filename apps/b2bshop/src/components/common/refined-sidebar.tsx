...
import { useFlashSellProductsQuery } from '@framework/basic-rest/product/get-all-flash-sell-products';
import { homeRefinedBanner as banner } from '@framework/basic-rest/static/banner';
