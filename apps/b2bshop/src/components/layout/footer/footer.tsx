...
import { SocialFooterFacebookLexir } from '@assets/svgs/footer-social-links/social-footer-facebook-lexir';
import { SocialFooterInstagramLexir } from '@assets/svgs/footer-social-links/social-footer-instagram-lexir';
import { SocialFooterLinkedinLexir } from '@assets/svgs/footer-social-links/social-footer-linkedin-lexir';
import { SocialFooterMediumLexir } from '@assets/svgs/footer-social-links/social-footer-medium-lexir';
import { LogoWhiteLexir } from '@assets/svgs/logo_lexir_white';
    ...
    <div className='flex flex-col items-center bg-[#2d2d2d] px-4 pt-16 pb-8 text-white md:px-8 xl:px-16 2xl:px-44'>
      <div className='flex w-full max-w-[1920px] flex-col justify-between pb-16 sm:px-10 md:flex-row lg:px-20 lg:pb-[72px]'>
        <div className='flex w-full flex-col md:w-3/12 md:pt-2'>
          <Link href='/'>
            <LogoWhiteLexir className='mb-7 h-5 w-20 cursor-pointer md:mb-0' />
          </Link>
        </div>
        <div className='flex w-full flex-wrap justify-between md:w-6/12'>
          <ul className='text-16 mb-8 flex w-full flex-col font-medium leading-8 md:w-1/2 lg:mb-0 lg:w-auto'>
          ...
          <ul className='text-16 mb-8 flex w-full flex-col font-medium leading-8 md:mb-0 md:w-1/2 lg:w-auto'>
