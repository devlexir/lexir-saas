    ...
    return (
      <div className={className}>
        {label && (
          <label
            htmlFor={name}
            className='mb-2 block cursor-pointer text-base font-normal leading-none text-brand-dark '
          >
            {label}
          </label>
        )}
        <div className='relative'>
          ...
          <label
            htmlFor={name}
            className='absolute top-5 -mt-2 cursor-pointer text-brand-dark text-opacity-30 ltr:right-4 rtl:left-4'
