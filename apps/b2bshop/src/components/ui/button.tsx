...
export interface ButtonProps extends ButtonHTMLAttributes<HTMLButtonElement> {
  className?: string;
  variant?: 'primary' | 'border' | 'formButton' | 'adButton' | 'tertiary';
  active?: boolean;
...
const Button = forwardRef<HTMLButtonElement, ButtonProps>((props, ref) => {
  ...
  const rootClassName = cn(
    ...
    {
      'h-12 md:h-14 bg-brand-dark text-brand-light tracking-widest px-5 md:px-6 lg:px-8 py-4 md:py-3.5 lg:py-4 hover:text-white hover:bg-opacity-90':
        variant === 'primary',
      'h-12 md:h-14 bg-brand-light text-brand-dark border border-border-four tracking-widest px-5 md:px-6 lg:px-8 py-4 md:py-3.5 lg:py-4 ':
        variant === 'border',
      'h-11 md:h-[50px] bg-brand-dark text-brand-light font-manrope px-5 lg:px-6 py-4 md:py-3.5 lg:py-4 hover:text-white hover:bg-opacity-90 focus:bg-opacity-70':
        variant === 'formButton',
      'h-[28px] md:h-[34px] text-brand-light px-5 lg:px-6 py-4 md:py-3.5 lg:py-4 hover:text-white hover:bg-opacity-90 focus:bg-opacity-70':
        variant === 'adButton',
      ' text-brand hover:text-brand': variant === 'tertiary',
